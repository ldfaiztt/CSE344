...
-- 137 rows and about 10 seconds on SQL Azure
...
--129 rows and about 12 seconds on SQL Azure
--OK if NULL year is excluded
select z.year, count(*)
from movie z
...
-- 128 rows and about 13 seconds on SQL Azure
...
-- Takes about 44 seconds on SQL Azure
...
--521,876 and about 50 seconds on SQL Azure
